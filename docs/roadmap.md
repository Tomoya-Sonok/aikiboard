...
| メンバーのロール変更(アドミン任命・解除)+ ボード削除(owner 限定) | #115 | 2026-09-10。R2-1 / R2-2 に対応。migration 追加なし(既存 FK の CASCADE を利用) |
...
| ~~[R1-3](#r1-3)~~ | ~~OAuth(Google)ログイン~~ **Google 完了(PR #117)**。Apple は別途 | P0 | M | ユーザー作業含む |
| [R1-4](#r1-4) | 利用規約・プライバシーポリシー | P0 | M | ユーザーレビュー必須 |
| ~~[R2-1](#r2-1)~~ | ~~アドミン任命・解除(ロール変更)~~ **完了(PR #115)** | P1(実質 P0) | M | — |
| ~~[R2-2](#r2-2)~~ | ~~ボード削除(オーナー)~~ **完了(PR #115)** | P1 | M | — |
...
<a id="r1-3"></a>
#### R1-3. OAuth(Google / Apple)ログイン — **Google は ✅ 完了(2026-09-10、PR #117)/ Apple は未着手**
...
<a id="r2-1"></a>
#### R2-1. アドミン任命・解除(ロール変更) — **✅ 完了(2026-09-10、PR #115)**
...
<a id="r2-2"></a>
#### R2-2. ボード削除(オーナー) — **✅ 完了(2026-09-10、PR #115)**
